...
namespace Modules\TeamMembers\App\Providers;
...
use Modules\TeamMembers\App\Repositories\TeamMemberRepository;
use Modules\TeamMembers\App\Repositories\TeamMemberRepositoryInterface;
use Modules\TeamMembers\App\Services\TeamMemberService;
...
class TeamMembersServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'TeamMembers';

    protected string $nameLower = 'teammembers';
